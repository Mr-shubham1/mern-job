...
export const postJob = async (req,res)=>{
    try {
        const {title,description,salary,location,jobtype,openings,experience,companyId} = req.body;
        if(!title || !description || !salary || !location || !jobtype || !openings || !experience || !companyId){
